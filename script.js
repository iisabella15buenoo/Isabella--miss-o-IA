        ...
        alternativas: [
            {
                ...
                afirmacao: "Representa uma visão positiva, considerando que qualificação e especialização podem ampliar as oportunidades profissionais."
            },
            {
                texto: "Acredito que o mercado apresenta desafios significativos, como a necessidade de investir constantemente na formação profissional e a dificuldade de se destacar diante da concorrência.",
                afirmacao: "Representa uma visão mais crítica, destacando a concorrência e a necessidade de atualização constante."
            }           
